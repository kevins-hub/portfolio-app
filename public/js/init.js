...
// Keep skating
  $("#ks.backstretched").backstretch(["/public/img/slides/ks-slide-1.png", "/public/img/slides/ks-slide-2.png", "/public/img/slides/ks-slide-3.png", ], {
    duration: 6000,
    fade: 1200
  });
...
// Jira
$("#jira.backstretched").backstretch(["/public/img/slides/jira-slide-1.jpg", ], {
  duration: 6000,
  fade: 1200
});
$("a[href*=#prev-slide]").on("click",function(event) {
...
// Manu-forecaster
$("#manu.backstretched").backstretch(["/public/img/slides/manu-slide-1.png", ], {
  duration: 6000,
  fade: 1200
});
$("a[href*=#prev-slide]").on("click",function(event) {
...
// Budget-me
$("#budget.backstretched").backstretch(["/public/img/slides/budget-slide-1.jpg","/public/img/slides/budget-slide-2.png", ], {
  duration: 6000,
  fade: 1200
});
$("a[href*=#prev-slide]").on("click",function(event) {
...
// Portfolio
$("#portfolio.backstretched").backstretch(["/public/img/slides/pf-slide-1.png","/public/img/slides/pf-slide-2.png", "/public/img/slides/pf-slide-3.png", "/public/img/slides/pf-slide-4.png", "/public/img/slides/pf-slide-5.png",  ], {
  duration: 6000,
  fade: 1200
});
$("a[href*=#prev-slide]").on("click",function(event) {
...
/*
  $("#home.backstretched").backstretch(["/public/img/slides/ks-slide-1.png", "/public/img/slides/ks-slide-2.png", "/public/img/slides/ks-slide-3.png", ], {
    duration: 6000,
    fade: 1200
  });
  $("a[href*=#prev-slide]").on("click",function(event) {
      ...
      console.log("in here")
        ...
        masonry_portfolio.imagesLoaded( function(){
             masonry_portfolio.isotope({
                ...
                //itemSelector: $(this).attr('data-filter'),
                filter: default_selector,
                masonry: {
